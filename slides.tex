...
\section{The problem}
\label{sec:org57f607b}
\begin{frame}[label={sec:org93ac846}]{Pharmacokinetics (PK) data}
\begin{columns}
...
\begin{frame}[label={sec:org4ccad4c}]{A Pharmacokinetics (PK) model}
\begin{align*}
...
\begin{frame}[label={sec:org639e0cb}]{A statistical model}
\begin{itemize}
...
\begin{frame}[label={sec:org8e0786b}]{Estimate \(\theta\)}
\begin{itemize}
...
\begin{frame}[label={sec:orgdb484e8}]{Prior \& likelihood}
\begin{align*}
  \log{p(\theta|y)} &= C + \log{p(y | \theta)} + \log{p(\theta)}
\end{align*}
\begin{center}
...
\begin{frame}[label={sec:org71b4b91}]{Sample the posterior}
...
\begin{frame}[label={sec:orga2818da}]{Posterior samples: trace}
\begin{center}
\includegraphics[width=\textwidth]{./figure/twoCpt_trace.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org5bab679}]{Posterior samples: density}
\begin{center}
...
\begin{frame}[label={sec:orgca20e34}]{The Metropolis-Hastings algorithm}
...
\begin{frame}[label={sec:org5ad4fa2}]{Why MCMC?}
\begin{quote}
...
\label{sec:org3b57200}
\begin{frame}[label={sec:org3f79220}]{The problem}
\begin{center}
\includegraphics[width=\textwidth]{./figure/twocpt_pop_ppc1.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd2b1c6d}]{Hierarchical model}
\begin{columns}
...
\begin{frame}[label={sec:orgb22c5b1}]{Challenges: high dimensional gaussian distribution}
...
\begin{frame}[label={sec:org09f8e88}]{Challenges: Geometry of posterior}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{align*}
  \theta_0 &= 0,\\
...
\label{sec:orgd5a2022}
\begin{frame}[label={sec:org1e5c613}]{A tale of two ODEs}
...
\begin{frame}[label={sec:org2cd74da}]{Automatic differentiation (1 obsv/subject: k=1)}
\begin{center}
\includegraphics[width=\textwidth]{./figure/autodiff_0_diag.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org702113b}]{Automatic differentiation (1 obsv/subject: k=1)}
\begin{center}
